...
1. Navigate to ["API keys" Settings page](https://app.contentful.com/spaces/v5apzttu6g7w/api/cma_tokens) of your Contentful space and generate new "Personal Access Token"
...
To start editing your site, you can use the Contentful interface at [https://app.contentful.com/spaces/v5apzttu6g7w](https://app.contentful.com/spaces/v5apzttu6g7w).
...
Generated at `2021-11-16T11:08:16.385Z` by Stackbit version `0.3.55`.